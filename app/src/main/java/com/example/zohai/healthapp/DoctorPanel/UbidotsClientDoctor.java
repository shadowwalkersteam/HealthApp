...
public class UbidotsClientDoctor {
    private UbiListenerDoctor listener;

    public UbiListenerDoctor getListener() {
        return listener;
    }

    public void setListener(UbiListenerDoctor listener) {
        this.listener = listener;
    }

    public void handleUbidots(String Datasource ,String varId, String apiKey, final UbiListenerDoctor listener) {
        ...
        client.newCall(req).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    ...
                    listener.onDataReadyDoctor(results);
    ...
    public interface  UbiListenerDoctor {
        void onDataReadyDoctor(List<Value> results);
    }
}
