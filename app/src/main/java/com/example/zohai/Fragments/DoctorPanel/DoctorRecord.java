...
public class DoctorRecord extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    public static DoctorRecord newInstance() {
        DoctorRecord fragment = new DoctorRecord();
        return fragment;
    }
...
//                     Convert timestamp to date
                ...
                final Handler handler = new Handler(DoctorRecord.this.getActivity().getMainLooper());
