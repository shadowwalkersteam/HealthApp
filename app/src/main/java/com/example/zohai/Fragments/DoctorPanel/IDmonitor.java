...
public class IDmonitor extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    public static IDmonitor newInstance() {
        IDmonitor fragment = new IDmonitor();
        return fragment;
    }
    public IDmonitor() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_idmonitor, container, false);
